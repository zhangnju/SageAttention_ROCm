...
// On AMD GPUs warpSize is a runtime value. Use a compile-time constant for shared memory.
#define MAX_WARP_SIZE 64
...
__inline__ __device__ T blockReduceSum(T val) {
  // static __shared__ T shared[MAX_WARP_SIZE];
  __shared__ T shared[MAX_WARP_SIZE];
...
{
    // static __shared__ T shared[NUM][MAX_WARP_SIZE + 1];
    __shared__ T shared[NUM][MAX_WARP_SIZE + 1];
    int lane = threadIdx.x & (warpSize - 1);
    int wid = threadIdx.x / warpSize;
